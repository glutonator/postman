...
//        Postman postman2 = new Postman(CustomGraph.createGraphForCyclicity(11, 11), 100, true, 10);
//        Postman postman3 = new Postman(CustomGraph.createGraphForDensity(10, 0.5), 60, true, 10);
